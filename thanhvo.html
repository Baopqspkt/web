		...
		<div id="wrapper">
										...
										<ul class="dropdown-menu">
											<li class="dropdown active">
												...
												<ul class="dropdown-menu active">
													...
													<li class="active"><a href="page-about-me-2.html">ABOUT ME - LAYOUT 2</a></li>
												</ul>
											</li>
											<li class="dropdown">
												<a class="dropdown-toggle" href="#">
			...
			<section class="page-header page-header-2xlg parallax parallax-4" style="background-image:url('demo_files/images/people/1200x800/2-min.jpg')">
				...
				<div class="container">
					...
					<h1 class="size-40">JOHN DOE</h1>
					<span class="font-lato size-18 weight-300">Art Director</span>
					...
					<div class="row">
						...
						<div class="col-md-9 col-sm-12"><!-- left text -->
							...
							<p class="font-lato weight-300 size-20 nomargin-bottom">
								I truly care about all of my clients.
							</p>
						</div><!-- /left text -->
				...
				<div class="container">
					...
					<ul class="timeline_center list-unstyled">
						<li>
							...
							<a href="portfolio-single-parallax.html" class="btn btn-xs btn-default margin-top-20">read more</a>
						</li>
			...
			<!-- RECENT WORK -->
			<section id="portfolio" class="portfolio-nogutter nopadding-bottom alternate">
				<div class="container">

					<header class="text-center margin-bottom-10">
						<h3>MY RECENT WORK</h3>
						<p class="font-lato weight-300 size-18 margin-top-10">Perferendis aliquam id pariatur accusantium </p>
					</header>
				...
				<div class="row mix-grid">
					...
					<div class="col-md-5th col-sm-4 mix design"><!-- item -->
					...
					<div class="col-md-5th col-sm-4 mix photography"><!-- item -->
			...
			<section>
				<div class="container">
					...
					<!-- Counters -->
					<div class="callout alert alert-border margin-top-100">
						<div class="row countTo-sm text-center">

							<div class="col-xs-6 col-sm-3 col-xs-6">
								<i class="ico-lg ico-transparent et-megaphone"></i>
								<div class="block size-50" style="color: #3498db;">
									<strong class="countTo size-50" data-speed="3000">1303</strong>
								</div>
							...
							<div class="col-xs-6 col-sm-3 col-xs-6">
								...
								<div class="block size-50" style="color: #e74c3c;">
							...
							<div class="col-xs-6 col-sm-3 col-xs-6">
								...
								<div class="block size-50" style="color: #16a085;">
									<strong class="countTo size-50" data-speed="3000">77</strong> %
								</div>
							...
							<div class="col-xs-6 col-sm-3 col-xs-6">
								...
								<div class="block size-50" style="color: #9b59b6;">
									<strong class="countTo size-50" data-speed="3000">9877</strong>
								</div>
